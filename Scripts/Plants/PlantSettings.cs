			...
			switch ((int)id)
			{
				...
				case 1:
					if (IsItemChecked(1))
					{
						...
						SceneChanger.zombieMain.GetNode<PopupMenu>("./Inside/VBox/MenuBar/设置").SetItemChecked(1, false);
					}
					else
					{
						...
						SceneChanger.zombieMain.GetNode<PopupMenu>("./Inside/VBox/MenuBar/设置").SetItemChecked(1, true);
					}
					break;
			}
		};
